...
public class Carousel{
	...
	public String  carouselfeature(Utilities utility){
		...
		for (OrderItem oi : utility.getCustomerOrders())
		{
			...
			if (hm.containsKey(oi.getName().toLowerCase().replaceAll(" ","")))  
			{	
				
		        myCarousel = "myCarousel"+l;
					
				sb.append("<div id='body'><div id='car_content'><div class='post' style='margin-left:-215px;'><h2>");
				sb.append("<a style='font-size: 24px;'> Accessories</a>");
				...
				*/
				...
				Console console1 = hm.get(oi.getName().toLowerCase().replaceAll(" ",""));
				System.out.print(oi.getName().toLowerCase().replaceAll(" ",""));
