...
public class Utilities extends HttpServlet{
	...
	public User getUser(){
		...
		String TOMCAT_HOME = System.getProperty("catalina.home");
			try
			{		
				FileInputStream fileInputStream=new FileInputStream(new File("/Users/parthpatel/Desktop/tomcat7/webapps/Tutorial_1/UserDetails.txt"));
	...
	public int getOrderPaymentSize(){
		...
		String TOMCAT_HOME = System.getProperty("catalina.home");
			try
			{
				FileInputStream fileInputStream = new FileInputStream(new File("/Users/parthpatel/Desktop/tomcat7/webapps/Tutorial_1/PaymentDetails.txt"));
				ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);	      
	...
	public void storePayment(int orderId,
		...
		listOrderPayment.add(orderpayment);	
			...
			try
			{	
				FileOutputStream fileOutputStream = new FileOutputStream(new File("/Users/parthpatel/Desktop/tomcat7/webapps/Tutorial_1/PaymentDetails.txt"));
