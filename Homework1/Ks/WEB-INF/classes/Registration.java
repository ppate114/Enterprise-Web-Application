...
public class Registration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else
			{
			    ...
			    FileOutputStream fileOutputStream = new FileOutputStream("/Users/parthpatel/Desktop/tomcat7/webapps/Tutorial_1/UserDetails.txt");
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<h2><a style='font-size: 24px;'>Login</a></h2>"
				+ "<div>"
