...
public class Trending extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		pw.print("<div id=''><div id='content'><div class='post' style='margin-left:-40px;margin-top:15px;'><h2 class='title meta'>");
		...
		pw.print("<div id='content'><div class='post' style='margin-left:-40px;margin-top:15px;'><h2 class='title meta'>");
