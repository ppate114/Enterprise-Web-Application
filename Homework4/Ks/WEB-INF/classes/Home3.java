...
public class Home3 extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("Welcome Store Manager..!</h2><table>");
		pw.print("<form method='post' action='#'>"
					
					+"<tr><td><input type='submit' class='btnbuy' value='Add Product'></input></td></tr>"
					+"<tr><td><input type='submit' class='btnbuy' value='Update Product'></input></td></tr>"
					+"<tr><td><input type='submit' class='btnbuy' value='Delete Product'></input></td></tr>");
