...
public class Utilities extends HttpServlet{
	...
	/*public void printHtml(String file) {
		...
		if (file == "Header.html") {
				//result=result+" <div id='nav' style='float: right;'><ul>";
			if (session.getAttribute("username")!=null){
				String username = session.getAttribute("username").toString();
				username = Character.toUpperCase(username.charAt(0)) + username.substring(1);
				result = result + "<li><a href='ViewOrder'>ViewOrder</span></a></li>"
						+ "<li><a>Hello,"+username+"</span></a></li>"
						+ "<li><a href='Account'>Account</span></a></li>"
						+ "<li><a href='Logout'>Logout</span></a></li>";
			}
			else
				result = result +"<li><a href='ViewOrder'>View Order</span></a></li>"+ "<li><a href='Login'>Login</span></a></li>";
				result = result +"<li><a href='Cart'><span class='glyphicon glyphicon-shopping-cart'>Cart("+CartCount()+")</span></a></li></ul></div></div>";
				pw.print(result);
		} else
				pw.print(result);
	}*/
	public void printHtml(String file) {
		...
		if (file == "Header.html") {
			...
			if (session.getAttribute("username")!=null){
				...
				{
					result = result + "<li><a href='ProductModify?button=Addproduct' style='padding:28px 5px 26px;font-size:10px'>Add</a></li>"
						+ "<li><a href='ProductModify?button=Updateproduct' style='padding:28px 5px 26px;font-size:10px'>Update</a></li>"
						+"<li><a href='ProductModify?button=Deleteproduct' style='padding:28px 5px 26px;font-size:10px'>Delete</a></li>"
						+"<li><a href='DataVisualization' style='padding:28px 5px 26px;font-size:10px'>Trending</a></li>"
						+"<li><a href='Sales' style='padding:28px 5px 26px;font-size:10px'>Sales</a></li>"
						+ "<li><a style='padding:28px 5px 26px;font-size:10px'>Hello,"+username+"</a></li>"
						+ "<li><a href='Logout' style='padding:28px 5px 26px;font-size:10px'>Logout</a></li>";
				}
				
				else if(session.getAttribute("usertype").equals("salesman")){
				...
				{
				result = result + "<li><a href='ViewOrder' style='padding:28px 5px 26px;font-size:10px'>ViewOrder</a></li>"
						+ "<li ><a style='padding:28px 5px 26px;font-size:10px'>Hello,"+username+"</a></li>"
						+ "<li><a href='Account' style='padding:28px 5px 26px;font-size:10px'>Account</a></li>"
						+ "<li><a href='Logout' style='padding:28px 5px 26px;font-size:10px'>Logout</a></li>";
			    }
			}
			else
				result = result +"<li><a href='ViewOrder' style='padding:28px 5px 26px;font-size:10px'>View Order</a></li>"+ "<li><a href='Login' style='padding:28px 5px 26px;font-size:10px'>Login</a></li>";
				result = result +"<li><a href='Cart' style='padding:28px 5px 26px;font-size:10px'>Cart("+CartCount()+")</a></li></ul></div></div><div id='page'>";
				pw.print(result);
		} else   
				pw.print(result);
	}
	...
	String message=MongoDBDataStoreUtilities.insertReview(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,retailername,retailerstate,productonsale,manufracturerrebate,userage,usergender,useroccupation);
		...
		Review review = new Review(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,price,city,
							retailername,retailerstate,productonsale,manufracturerrebate,userage,usergender,useroccupation);
