...
/* displayCart Function shows the products that users has bought, these products will be displayed with Total Amount.*/
	...
	protected void displayCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<div id='car_content' style='margin-right: -65px;margin-top: -862px;'><div class='post' style='margin-top:135px;'><h2 class='title meta'>");
		pw.print("<a style='font-size: 24px;'>Cart("+utility.CartCount()+")</a>");
		pw.print("</h2><div class='entry' style='margin-bottom:600px;'>");
