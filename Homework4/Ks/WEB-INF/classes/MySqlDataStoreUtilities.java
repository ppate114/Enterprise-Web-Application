...
public static void main (String args[])
{
	...
	Insertproducts();
	System.out.println("accessories received");
}
...
public static String getConnection()
{
	...
	conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/exampledatabase","root","Parth@237");							
	message="Successfull";
	return message;
	}
...
public static void Insertproducts()
{
	try{
		...
		getConnection();
		SaxParserDataStore newObj=new SaxParserDataStore("/Users/parthpatel/Desktop/tomcat7/webapps/Ks/ProductCatalog2.xml");
		...
		"VALUES (?,?,?,?,?,?,?,?);";
		/*for(Map.Entry<String,Accessory> entry : newObj.accessories.entrySet())
		{   
			String name = "accessories";
	        Accessory acc = entry.getValue();
			System.out.println("Product Insert"+acc.getName());
		...
		for(Map.Entry<String,Console> entry : newObj.consoles.entrySet())
		{   
			...
			PreparedStatement pst = conn.prepareStatement(insertProductQurey);
			System.out.println("Product Insert"+con.getName()); 
			pst.setString(1,name);
...
{	
	System.out.println("In getAccessories 1");  
	HashMap<String,Accessory> hm=new HashMap<String,Accessory>();
	try 
	{
		System.out.println("In getAccessories 2");
		getConnection();
		System.out.println("In getAccessories 3");
		String selectAcc="select * from  Productdetails where ProductType=?";
		System.out.println("In getAccessories 4");
